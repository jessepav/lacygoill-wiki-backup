// Purpose: show how to pay a user-inputted amount using the smallest number of $20, $10, $5, and $1 bills
...
int main(void)
{
    ...
    //     ...
    //
    // But I find they make the code more logical/readable.
    ...
    //     amount -= amount;
    //
    // Which would be wrong.  But that's not what happens.
    // In any case, with our current  implementation, there is no doubt that the
    // code works; no simplification could fuck it up.
    //}}}
