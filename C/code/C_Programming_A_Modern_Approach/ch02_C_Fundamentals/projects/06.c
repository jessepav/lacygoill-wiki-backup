// Purpose: modify the program of 05.c so that the polynomial is rewritten as `(((((3x + 2)x - 5))x - 1)x + 7)x - 6`
...
int main(void)
{
    ...
    // That's much effective.
    //
    // ---
    //
    // This technique of factorization is called **Horner's Rule**.
    //
