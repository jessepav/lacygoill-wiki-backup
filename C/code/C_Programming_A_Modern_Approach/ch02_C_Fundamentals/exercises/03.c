...
int main(void)
{
    // Notice how you can put linebreaks inside a statement.{{{
    //
    // It can be  useful to vertically align some tokens;  here, variables in an
    // assignment.  This  is possible  (without continuation symbols)  thanks to
